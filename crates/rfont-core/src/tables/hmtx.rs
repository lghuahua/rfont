...
mod tests {
    ...
    fn test_hmtx_read_basic() {
        ...
        let data = vec![
            ...
            0x01, 0xF4, 0x00, 0x32, // LongHorMetric 2: advance_width=600, lsb=60
            0x02, 0x58, 0x00, 0x3C, // LeftSideBearing for glyph 3: lsb=70
            0x00, 0x46,
        ];
    ...
    fn test_hmtx_read_all_long_metrics() {
        ...
        let data = vec![
            // Glyph 0
            0x01, 0xF4, 0x00, 0x32, // Glyph 1
            0x02, 0x58, 0x00, 0x3C, // Glyph 2
            0x03, 0xE8, 0x00, 0x46,
        ];
    ...
    fn test_hmtx_read_single_glyph() {
        // 测试只有一个字形的情况
        let data = vec![0x01, 0xF4, 0x00, 0x32];
    ...
    fn test_hmtx_get_metric() {
        let data = vec![0x01, 0xF4, 0x00, 0x32, 0x02, 0x58, 0x00, 0x3C];
    ...
    fn test_hmtx_many_remaining_lsbs() {
        ...
        let mut data = vec![
            // LongHorMetric 1
            0x01, 0xF4, 0x00, 0x32, // LongHorMetric 2
            0x02, 0x58, 0x00, 0x3C,
        ];
    ...
    fn test_hmtx_number_of_metrics_less_than_glyphs() {
        ...
        let mut data = vec![
            ...
            0x01, 0xF4, 0x00, 0x32, // LongHorMetric 2: advanceWidth=600, lsb=60
            0x02, 0x58, 0x00, 0x3C, // LongHorMetric 3: advanceWidth=700, lsb=70
            0x02, 0xBC, 0x00, 0x46,
        ];
    ...
    fn test_hmtx_zero_width_glyphs() {
        ...
        let data = vec![
            ...
            0x00, 0x00, 0x00, 0x00, // Control char: advanceWidth=0, lsb=0
            0x00, 0x00, 0x00, 0x00, // Normal char: advanceWidth=500, lsb=50
            0x01, 0xF4, 0x00, 0x32,
        ];
    ...
    fn test_hmtx_extreme_values() {
        ...
        let data = vec![
            ...
            0xFF, 0xFF, 0x7F, 0xFF, // Min advanceWidth: 0, Min lsb: -32768
            0x00, 0x00, 0x80, 0x00,
        ];
